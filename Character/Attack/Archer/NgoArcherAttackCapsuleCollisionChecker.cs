...
namespace Character.Attack.Archer
{
    ...
    [RequireComponent(typeof(NgoArcherAttackInitialize))]
    public class NgoArcherAttackCapsuleCollisionChecker : NetworkBehaviour
    {
        private const string ArcherAttackHitPath = "Prefabs/Player/VFX/Archer/ArcherAttackHit";
        ...
        private NgoArcherAttackInitialize _initialize;
        ...
        private void Awake()
        {
            ...
            _initialize = GetComponent<NgoArcherAttackInitialize>();
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            _vfxManagerServices.InstantiateParticleInArea(ArcherAttackHitPath, transform.position);
