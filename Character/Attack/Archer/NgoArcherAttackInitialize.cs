...
namespace Character.Attack.Archer
{
    public class NgoArcherAttackInitialize : NgoPoolingInitializeBase
    {
        ...
        {
            [Inject]
            public ArcherAttackFactory(DiContainer container, IFactoryManager factoryManager,
        ...
        private float _arrowMoveSpeed = 20f;
        ...
        public override void OnNetworkSpawn()
        {
           ...
           _resources.DestroyObject(gameObject,5f); //무한히 날아가는걸 방지
        }
        ...
        IEnumerator Move(GameObject go)
        {
            ...
            {
                // 이번 프레임에 이동할 거리 계산
                float moveDistance = _arrowMoveSpeed * Time.deltaTime;
        ...
        private void OnHit(RaycastHit hit)
        {
            ...
            _vfxManager.InstantiateParticleInArea(NgoArcherAttackHitPath,gameObject.transform.position);
            
        }
        private string NgoArcherAttackHitPath => "Prefabs/Player/VFX/Archer/ArcherAttackHit";
