...
namespace Character.Skill.AllofSkills.Acher
{
    ...
    [RequireComponent(typeof(NgoArcherMultiShotInitialize))]
    public class NgoArcherMultiShotCapsuleCollisionChecker : NetworkBehaviour
    {
        private const string MultiShotHitPath = "Prefabs/Player/VFX/Archer/Skill/MultiShot_hit";
        ...
        private NgoArcherMultiShotInitialize _initialize;
        ...
        private void Awake()
        {
            ...
            _initialize = GetComponent<NgoArcherMultiShotInitialize>();
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            _vfxManagerServices.InstantiateParticleInArea(MultiShotHitPath, transform.position);
