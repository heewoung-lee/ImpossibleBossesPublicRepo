...
namespace Character.Skill.AllofSkills.Acher
{
    public class NgoArcherMultiShotInitialize: NgoPoolingInitializeBase
    {
        ...
        private void OnHit(RaycastHit hit)
        {
            ...
            _vfxManager.InstantiateParticleInArea(NgoArcherMultiShotHitPath,gameObject.transform.position);
            
        }
        
        private string NgoArcherMultiShotHitPath => "Prefabs/Player/VFX/Archer/Skill/MultiShot_hit";
