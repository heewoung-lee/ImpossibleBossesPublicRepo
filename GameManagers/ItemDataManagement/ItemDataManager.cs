...
namespace GameManagers.ItemDataManagement
{
    public class ItemDataManager : IItemDataManager
    {
        ...
        public ItemDataSO GetRandomItemData(ItemType type, ItemGradeType grade)
        {
            List<ItemDataSO> filteredList = _itemDatabase.Values
                .Where(x => x.ItemType == type && x.itemGrade == grade)
                .ToList();
        ...
        public List<ItemDataSO> GetItemDataList(ItemType type)
        {
