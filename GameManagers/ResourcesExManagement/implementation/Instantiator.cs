...
namespace GameManagers.ResourcesExManagement.implementation
{
        ...
        IRegistrar<IDefaultGameObjectFactory>
    {
        ...
        {
            Debug.Assert(_defaultGameObjectFactory != null, "defaultContainer Is null"); 

            Assert.IsNotNull(prefabObj, $"{prefabObj.name} Is null");
