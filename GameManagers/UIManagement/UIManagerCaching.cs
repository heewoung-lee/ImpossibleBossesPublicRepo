...
namespace GameManagers.UIManagement
{
    internal class UIManagerRequestCaching: IRegistrar<ICachingForUI>,IUIManagerServices
    {
        ...
        public void AddImportant_Popup_UI(UIPopup importantUI)//when you use this method you must call after object Injected
        {
        ...
        {
            return _popupManager.IsTopPopupUI(popup);
        }
        ...
        {
            return _popupManager.IsAnyPopupOpen();
        }
