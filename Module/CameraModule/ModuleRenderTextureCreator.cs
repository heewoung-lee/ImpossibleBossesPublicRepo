...
{
    public class ModuleRenderTextureCreator : MonoBehaviour
    {
        ...
        private void OnDisable()
        {
            ...
            if (_renderTexture != null)
            {
                ...
                _renderTexture = null;
                _chracterChooseCamera.targetTexture = null;
            }
        }
        
        void OnDestroy()
        {
            if (_chracterChooseCamera != null && _chracterChooseCamera.targetTexture != null)
            {
                _chracterChooseCamera.targetTexture = null;
            }
            if (_renderTexture != null)
