...
{
    public class GamePlaySceneTesterInstaller : MonoInstaller,ITestInstaller
    {
        public override void InstallBindings()
        {
            ...
            //Container.Rebind<BossRoomEntrancePosition>().FromInstance(new BossRoomEntrancePosition(new Vector3(0,0,0)));
            //포탈 위치 테스트
