...
{
    public class RoomSceneTestInstaller : MonoInstaller
    {
        public override void InstallBindings()
        {
         
            Container.BindInterfacesAndSelfTo<RoomPlayTestScene>().FromComponentInHierarchy().AsSingle();//테스트 에디터 바인드
         
            Container.Bind<BaseScene>()
                .FromResolveGetter<RoomPlayTestScene>(t => t.GetComponent<BaseScene>());
