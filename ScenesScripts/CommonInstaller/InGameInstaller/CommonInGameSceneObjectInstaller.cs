...
namespace ScenesScripts.CommonInstaller.InGameInstaller
{
    ...
    public class CommonInGameSceneObjectInstaller : Installer<CommonInGameSceneObjectInstaller>
    {
        ...
        public override void InstallBindings()
        {
            ...
            Container.BindInterfacesAndSelfTo<NgoGetExpInitialize.NgoGetExpFactory>().AsSingle();
            Container.BindInterfacesAndSelfTo<NgoLevelUpInitialize.NgoLevelUpFactory>().AsSingle();
            Container.BindInterfacesAndSelfTo<NgoStunVFXInitialize.NgoStunVFXFactory>().AsSingle();
