...
namespace ScenesScripts.FirstBossScene.Spawner
{
    public class NgoFirstBossSceneSpawn : NetworkBehaviourBase
    {
        public class NgoFirstBossSceneSpawnFactory : NgoZenjectFactory<NgoFirstBossSceneSpawn>
        {
            public NgoFirstBossSceneSpawnFactory(DiContainer container, IFactoryManager factoryManager,
        ...
        private void HostSpawnObject()
        {
            ...
            GameObject spawnedBoss = _relayManager.SpawnNetworkObj(bossGolemController.gameObject, _relayManager.NgoRoot.transform,
