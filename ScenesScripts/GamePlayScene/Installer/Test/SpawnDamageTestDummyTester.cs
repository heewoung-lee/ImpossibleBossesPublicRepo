...
namespace ScenesScripts.GamePlayScene.Installer.Test
{
    public class SpawnDamageTestDummyTester : ISceneSpawn
    {
        public void SpawnObject(IResourcesServices resources, RelayManager relayManager)
        {
            ...
            BaseStats dummy2 = resources.InstantiateByKey("Prefabs/NPC/DamageTestDummy").GetComponent<BaseStats>();
            relayManager.SpawnNetworkObj(dummy2.gameObject, relayManager.NgoRoot.transform,
                position: new Vector3(6f, 0, -4.5f));

            BaseStats dummy3 = resources.InstantiateByKey("Prefabs/NPC/DamageTestDummy").GetComponent<BaseStats>();
            relayManager.SpawnNetworkObj(dummy3.gameObject, relayManager.NgoRoot.transform,
                position: new Vector3(4f, 0, 3.5f));

            BaseStats dummy4 = resources.InstantiateByKey("Prefabs/NPC/DamageTestDummy").GetComponent<BaseStats>();
            relayManager.SpawnNetworkObj(dummy4.gameObject, relayManager.NgoRoot.transform,
                position: new Vector3(2f, 0, +2.5f));

            BaseStats dummy5 = resources.InstantiateByKey("Prefabs/NPC/DamageTestDummy").GetComponent<BaseStats>();
            relayManager.SpawnNetworkObj(dummy5.gameObject, relayManager.NgoRoot.transform,
                position: new Vector3(0f, 0, 2.5f));

            BaseStats dummy6 = resources.InstantiateByKey("Prefabs/NPC/DamageTestDummy").GetComponent<BaseStats>();
