...
namespace ScenesScripts
{
    public class LoadingScene : BaseScene
    {
        ...
        public override Define.SceneName CurrentSceneName => Define.SceneName.LoadingScene;
        ...
        {
            AsyncOperation operation = SceneManager.LoadSceneAsync(_sceneManagerEx.NextSceneName.ToString());
