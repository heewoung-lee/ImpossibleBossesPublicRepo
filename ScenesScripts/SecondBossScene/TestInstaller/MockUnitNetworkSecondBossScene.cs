...
{
    public class MockUnitNetworkSecondBossScene : ISceneSpawnBehaviour
    {
        ...
        [Inject]
        public MockUnitNetworkSecondBossScene(
        ...
        private NgoSecondBossSceneSpawn _ngoGamePlaySceneSpawn;
        ...
        public void SpawnObj()
        {
            ...
            void InitNgoPlaySceneOnHost()
            {
                ...
                {
                    _ngoGamePlaySceneSpawn = _resourceService.InstantiateByKey("Prefabs/NGO/NgoSecondBossSceneSpawn")
