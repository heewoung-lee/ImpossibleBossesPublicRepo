...
{
    public class MockUnitNetworkSecondBossSceneWithLoading : ISceneSpawnBehaviour
    {
        ...
        [Inject]
        public MockUnitNetworkSecondBossSceneWithLoading(
        ...
        private NgoSecondBossSceneSpawn _ngoSecondBossSceneSpawn;
        ...
        public void SpawnObj()
        {
            ...
            void InitNgoPlaySceneOnHost()
            {
                ...
                {
                    _ngoSecondBossSceneSpawn = _resourceService.InstantiateByKey("Prefabs/NGO/NgoSecondBossSceneSpawn")
                        .GetComponent<NgoSecondBossSceneSpawn>();
                    _relayManager.SpawnNetworkObj(_ngoSecondBossSceneSpawn.gameObject, _relayManager.NgoRoot.transform);
                }
            }
