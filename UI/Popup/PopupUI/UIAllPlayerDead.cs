...
{
    public class UIAllPlayerDead : UIScene
    {
        ...
        private const string AllPlayerDeadSoundCueId = "UIAllPlayerDead";
        private const string AllPlayerDeadMessageFormat = "모든 플레이어가 쓰러졌습니다.\n{0}초후 로비로 이동합니다.";
        ...
        private TMP_Text _allPlayerDeadText;
        ...
        protected override void AwakeInit()
        {
            ...
            _allPlayerDeadText = Get<TMP_Text>((int)Texts.TextALlPlayerDead);
            _revealObjects = new[]
            {
                GetObject((int)Objects.ContinueTitle),
                GetObject((int)Objects.TextALlPlayerDead),
                GetObject((int)Objects.ButtonMoveLobby)
            };
            
            for(int i = 0; i<_revealObjects.Length; i++) _revealObjects[i].SetActive(false);
        ...
        protected override void ZenjectEnable()
        {
            ...
            _soundManagerServices.PlayUiSfx(gameObject, AllPlayerDeadSoundCueId);
            ...
            UpdateAllPlayerDeadText(AutoMoveToLobbyDelaySeconds);
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    if (remainingSeconds != previousRemainingSeconds)
                    {
                        ...
                        UpdateAllPlayerDeadText(remainingSeconds);
                    }
        ...
        private void UpdateAllPlayerDeadText(int remainingSeconds)
        {
            _allPlayerDeadText.text = string.Format(AllPlayerDeadMessageFormat, remainingSeconds);
        }
